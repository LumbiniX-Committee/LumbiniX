...
export const sponsors: Sponsor[] = [
  ...
  {
    name: "Butwal Computer Supplier",
    logo: "/sponsors/butwal-computer.png",
    tier: "bronze",
  ...
  {
    name: "The Chocolatier Nepal",
    logo: "/sponsors/chocolatier-nepal.png",
    tier: "bronze",
